...
static const struct pin_index pins[] =
{
    ...
    __STM32_PIN_RESERVE,        //     :  VBAT
    __STM32_PIN(7, C, 13),      // PC13:  SD_CS        --> SD_CARD
    __STM32_PIN(8, C, 14),      // PC14:  OSC32_IN
    __STM32_PIN(9, C, 15),      // PC15:  OSC32_OUT
    __STM32_PIN_RESERVE,        //     :  VSS
    __STM32_PIN_RESERVE,        //     :  VDD
    __STM32_PIN_RESERVE,        // PH0 :  OSC_IN
    __STM32_PIN_RESERVE,        // PH1 :  OSC_OUT
    __STM32_PIN_RESERVE,        //     :  RESET
    ...
    __STM32_PIN_RESERVE,        //     :  VSSA
    __STM32_PIN_RESERVE,        //     :  VREF-
    __STM32_PIN_RESERVE,        //     :  VREF+
    __STM32_PIN_RESERVE,        //     :  VDDA
